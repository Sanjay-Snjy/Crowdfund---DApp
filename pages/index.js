...
import { useCachedIPFSMetadata, useCachedWalletProfile, useCachedCampaignList } from "../utils/reactQuery";
...
export default function Home() {
  ...
  const { data: campaignsForLanding, isLoading: recentCampaignsLoading } = useCachedCampaignList(0, 4);
  ...
  useEffect(() => {
    ...
    visibleRecentCampaigns.forEach((campaign) => {
